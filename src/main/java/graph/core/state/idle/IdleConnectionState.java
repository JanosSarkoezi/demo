...
public class IdleConnectionState implements EditorState {
    ...
    private void refreshPorts(StateContext context) {
        ...
        // 2. Über alle selektierten Shapes iterieren
        for (Node selectedNode : context.getSelectionManager().getSelectedNodes()) {
            ...
            for (Port p : ports) {
                ...
                // MATHEMATISCHER FIX:
                // Da wir den Port an die translateX/Y Property binden, wird der
                // aktuelle Versatz des Shapes vom JavaFX-System automatisch addiert.
                // Wir müssen also die absolute Weltposition des Ports nehmen und den
                // aktuellen Versatz des Shapes abziehen, um den "Ankerpunkt" zu setzen.
                ...
                // DAS BINDING:
                // Jetzt klebt der Port am Shape. Jede weitere Änderung von
                // TranslateX/Y im MoveState verschiebt den Port live mit.
